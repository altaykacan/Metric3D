...
DEFAULT_WEIGHT_PATH = Path("./weight/convlarge_hourglass_0.3_150_step750k_v1.1.pth")
DEFAULT_CONFIG_PATH = Path("./mono/configs/HourglassDecoder/convlarge.0.3_150_deepscenario.py") # input image resizing (called crop) defined in the config file
